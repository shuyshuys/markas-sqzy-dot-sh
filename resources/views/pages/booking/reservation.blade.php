    ...
    <form method="POST" action="{{ route('booking.store') }}">
        ...
        <div class="mt-8">
          <div class="mb-3">
            ...
            <input type="text" name="name" class="form-control rounded-2xl py-2.5" id="exampleFormControlInput1">
          </div>
          ...
          <div class="mb-3">
            ...
            <div class="flex font-bold">
              ...
              <div class="form-check">
                <input type="radio" class="form-check-input" id="radio2" name="gender" value="femele">
          ...
          <div class="mb-3">
            ...
            <input type="email" name="email" class="form-control rounded-2xl py-2.5" id="exampleFormControlInput1">
          </div>

          <div class="mb-3">
            <label for="exampleFormControlInput1" class="form-label font-bold">Nomor Telepon</label>
            <input type="number" name="phone" class="form-control rounded-2xl py-2.5" id="exampleFormControlInput1">
          </div>

          <div class="mb-3">
            <label for="exampleFormControlInput1" class="form-label font-bold">Instansi/Komunitas/Perusahaan</label>
            <input type="text" name="company" class="form-control rounded-2xl py-2.5" id="exampleFormControlInput1">
          </div>

          <div class="mb-3">
            <label for="exampleFormControlInput1" class="form-label font-bold">Jenis Kegiatan</label>
            <input type="text" name="event_type" class="form-control w-3/12 rounded-2xl py-2.5" id="exampleFormControlInput1">
          </div>

          <div class="mb-3">
            <label for="exampleFormControlInput1" class="form-label font-bold">Nama Kegiatan</label>
            <input type="text" name="event_name" class="form-control rounded-2xl py-2.5" id="exampleFormControlInput1">
          </div>

          <div class="mb-3">
            <label for="exampleFormControlInput1" class="form-label font-bold">Deskripsi Singkat</label>
            <textarea class="form-control rounded-2xl" rows="8" id="comment"  name="description"></textarea>
          </div>

          <div class="text-right">
            <button type="submit" class="backbutton py-2 rounded-2xl bg-[#D90027] text-white px-24 text-lg mt-14 mb-6">
            Pesan
            </button>
          </div>
    </form>
